...
#import "sqlite3.h"
#import "Kii_FMResultSet.h"
#import "Kii_FMDatabasePool.h"


#if ! __has_feature(objc_arc)
    #define Kii_FMDBAutorelease(__v) ([__v autorelease]);
    #define Kii_FMDBReturnAutoreleased Kii_FMDBAutorelease

    #define Kii_FMDBRetain(__v) ([__v retain]);
    #define Kii_FMDBReturnRetained Kii_FMDBRetain

    #define Kii_FMDBRelease(__v) ([__v release]);

	#define Kii_FMDBDispatchQueueRelease(__v) (dispatch_release(__v));
#else
    // -fobjc-arc
    #define Kii_FMDBAutorelease(__v)
    #define Kii_FMDBReturnAutoreleased(__v) (__v)

    #define Kii_FMDBRetain(__v)
    #define Kii_FMDBReturnRetained(__v) (__v)

    #define Kii_FMDBRelease(__v)

	#if TARGET_OS_IPHONE
		// Compiling for iOS
		#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 60000
			// iOS 6.0 or later
			#define Kii_FMDBDispatchQueueRelease(__v)
		#else
			// iOS 5.X or earlier
			#define Kii_FMDBDispatchQueueRelease(__v) (dispatch_release(__v));
		#endif
...
@interface Kii_FMDatabase : NSObject  {
...
- (Kii_FMResultSet *)executeQuery:(NSString*)sql, ...;
- (Kii_FMResultSet *)executeQueryWithFormat:(NSString*)format, ...;
- (Kii_FMResultSet *)executeQuery:(NSString *)sql withArgumentsInArray:(NSArray *)arguments;
- (Kii_FMResultSet *)executeQuery:(NSString *)sql withParameterDictionary:(NSDictionary *)arguments;
...
@interface Kii_FMStatement : NSObject {
